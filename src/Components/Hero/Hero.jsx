          ...
          >
            <div className=" bg-[#e8e9eabb] rounded-md xl:px-16 lg:px-12 md:px-10 sm:px-8 px-3 xl:py-20 lg:py-12 md:py-10 py-8   w-full absolute left-1/2 xl:top-60 md:top-50 sm:top-[60px] top-[90px] -translate-x-1/2 z-10">
              <div className="relative">
                <div className="absolute xl:-top-28 md:-top-18 -top-13 left-1/2 -translate-x-1/2">
                  <h5 className="px-4 py-3 overflow-hidden md:w-[500px] w-[300px] text-center rounded-full bg-primary1 text-nu10 font-medium md:text-[24px] text-[14px] ">
                ...
                <div className="absolute xl:-bottom-26 md:-bottom-16 -bottom-13 left-1/2 -translate-x-1/2">
